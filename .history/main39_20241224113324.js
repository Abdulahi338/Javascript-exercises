...
async function fetchLanguages() {
    const url = 'https://microsoft-translator-text-api3.p.rapidapi.com/languages';    const options = {
        method: 'GET',
        headers: {
            'x-rapidapi-key': 'ca90974d93msh9216af776397d8bp121fa2jsn87781afa5447', // Replace with your RapidAPI key
            'x-rapidapi-host': 'microsoft-translator-text-api3.p.rapidapi.com',
        },
    };
